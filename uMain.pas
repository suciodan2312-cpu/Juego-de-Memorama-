...
begin
  // Validamos nombres rápido
  if (edtJ1.Text = '') or (edtJ2.Text = '') then
  begin
    ShowMessage('Pon los nombres de los jugadores');
    Exit;
  end;

  // 1. Cargamos las fotos del tema seleccionado al ImageList
